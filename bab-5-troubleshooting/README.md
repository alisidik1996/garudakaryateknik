...
# 🛠️ Modul 5: Pengecekan Form Masuk, Instagram Feed, & Troubleshooting GKT
...
1. **Notifikasi Email Masuk**: Dikirim langsung ke `office@garudakaryateknik.com`.
...
2. Di menu sebelah kiri, buka **Elementor** $\rightarrow$ klik **Submissions** (atau buka menu **WPForms** $\rightarrow$ **Entries**).
3. Anda akan melihat tabel daftar pengirim memuat:
...
4. Klik **View** pada pesan untuk melihat detail lengkap, lalu segera teruskan ke tim estimasi/sales.
...
> 1. Di menu dashboard kiri, buka **Instagram Feed** $\rightarrow$ **All Feeds**.
...
- **WhatsApp Teknis**: `0821 2864 4561` *(atau nomor kontak Tuan Ali)*
