...
Sistem klasifikasi kategori pada backend PT Garuda Karya Teknik membedakan antara kategori portofolio fisik (**Projects**) dan kategori wawasan tulisan (**Artikel**).

---

## 2.2.1 Daftar Kategori Aktif di Database Website

Berikut adalah daftar kategori resmi yang telah terdaftar di database Web GKT:
...
| **Interior Apartment Studio**   | `interior-apartment-studio` | ID: 13      | Portofolio khusus unit apartemen dan hunian                 |
...
Jika ingin memperluas cakupan portofolio (misalnya proyek gedung industri atau pabrikasi):
...
2. Di formulir sebelah kiri:
   ...
   - **Slug**: Masukkan format URL (contoh: `commercial-office-building`).
...
>
>1. **Hindari Kategori "Uncategorized"**: Jangan biarkan proyek tersimpan di bawah kategori bawaan *Uncategorized*.
